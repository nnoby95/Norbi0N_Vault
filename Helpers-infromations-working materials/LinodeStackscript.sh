...
git clone https://github.com/nnoby95/Norbi0N_Vault src
...
#######################################################
# Register Hungarian (.hu) TLD servers
###
...
# Enabled for Hungarian vault - provides full feature set for advanced players
Environment=Behavior__DisableFakeScript=false
